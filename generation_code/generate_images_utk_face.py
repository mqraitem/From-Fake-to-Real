...
target_negative_dict = {    
    "young": ["baby", "aged three years old", "aged four years old", "aged five years old"] ,
    "old": ["in their twenties", "in their thirties", "in their forties", "in their fifties"]
}
...
dir_path = f"generated_images/utk_face/{args.gender}/{args.bias}"
...
while count < num_images_max: 
    ...
    for _ in range(num_images):
        prompt = f"a headshot of a human {args.gender} {random.choice(target_negative_dict[args.bias])}"
